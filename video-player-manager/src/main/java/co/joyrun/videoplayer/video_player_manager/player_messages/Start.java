...
/**
 * This PlayerMessage calls {@link MediaPlayer#start()} on the instance that is used inside {@link VideoInterfaceV2}
 */
public class Start extends PlayerMessage{
    ...
    public Start(VideoInterfaceV2 videoPlayerView, VideoPlayerManagerCallback callback) {
