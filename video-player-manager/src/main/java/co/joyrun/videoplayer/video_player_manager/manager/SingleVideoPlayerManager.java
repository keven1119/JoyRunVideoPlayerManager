...
import co.joyrun.videoplayer.video_player_manager.player_messages.ClearPlayerInstance;
import co.joyrun.videoplayer.video_player_manager.player_messages.CreateNewPlayerInstance;
import co.joyrun.videoplayer.video_player_manager.player_messages.SetAssetsDataSourceMessage;
import co.joyrun.videoplayer.video_player_manager.MessagesHandlerThread;
...
import co.joyrun.videoplayer.video_player_manager.player_messages.Prepare;
import co.joyrun.videoplayer.video_player_manager.player_messages.Release;
import co.joyrun.videoplayer.video_player_manager.player_messages.Reset;
import co.joyrun.videoplayer.video_player_manager.SetNewViewForPlayback;
import co.joyrun.videoplayer.video_player_manager.player_messages.SetUrlDataSourceMessage;
import co.joyrun.videoplayer.video_player_manager.player_messages.Stop;
...
//    private boolean isAutoPlay = true;
     ...
     */
    @Override
    public void playNewVideo(MetaData currentItemMetaData, VideoInterfaceV2 videoPlayerView, String videoUrl) {
     ...
     * 5. Resume stopped queue
     *
     * This method is basically a copy-paste of {@link #playNewVideo(MetaData, VideoInterfaceV2, String)}
     ...
     */
    @Override
    public void playNewVideo(MetaData currentItemMetaData, VideoInterfaceV2 videoPlayerView, AssetFileDescriptor assetFileDescriptor) {
     ...
     * "Clear instance" means removing instance of {@link android.media.MediaPlayer} and not the {@link VideoInterfaceV2}
     ...
     */
    private void startNewPlayback(MetaData currentItemMetaData, VideoInterfaceV2 videoPlayerView, AssetFileDescriptor assetFileDescriptor) {
    ...
    /**
     * This is copy paste of {@link #startNewPlayback(MetaData, VideoInterfaceV2, AssetFileDescriptor)}
     * The difference is that this method uses AssetFileDescriptor instead of direct path
     */
    private void startNewPlayback(MetaData currentItemMetaData, VideoInterfaceV2 videoPlayerView, String videoUrl) {
        // set listener for new player
...
//                new Start(videoPlayerView, this)
     ...
     */
    private void setNewViewForPlayback(MetaData currentItemMetaData, VideoInterfaceV2 videoPlayerView) {
     ...
     */
    @Override
    public void setCurrentItem(MetaData currentItemMetaData, VideoInterfaceV2 videoPlayerView) {
     ...
     */
    @Override
    public void setVideoPlayerState(VideoInterfaceV2 videoPlayerView, PlayerMessageState playerMessageState) {
